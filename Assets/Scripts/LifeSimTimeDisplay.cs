...
public class LifeSimTimeDisplay : TimeUI
{
    public TextMeshProUGUI dayText; // Reference to a UI Text element that displays the current day
    public TextMeshProUGUI dayOfWeekText; // Reference to a UI Text element that displays the current day of week
